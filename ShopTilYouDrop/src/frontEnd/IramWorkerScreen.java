...
public class IramWorkerScreen extends ClickableScreen implements WorkerInterface, Runnable {
	...
	public void initAllObjects(ArrayList<Visible> viewObjects) {
		...
		topBun.setAction(new Action() {//
			...
			public void act() {
				burger.add("top_bun");
				ClickableGraphic tpbn = new ClickableGraphic(300, 300 -(burger.size() * 12), 150, 150, "resources/top_bun.png");
				addObjects(tpbn);
			}
		...
		patty.setAction(new Action() {
			...
			public void act() {
				burger.add("patty");
				ClickableGraphic ptty = patty = new ClickableGraphic(300, 300 -(burger.size() * 10), 150, 150, "resources/patty.png");
				addObjects(ptty);
			}
		...
		lettuce.setAction(new Action() {
			...
			public void act() {
				burger.add("lettuce");
				ClickableGraphic lttc = lettuce = new ClickableGraphic(300,300 -(burger.size() * 10),150, 150, "resources/lettuce.png");
				addObjects(lttc);
			}
		...
		cheese.setAction(new Action() {
			...
			public void act() {
				burger.add("cheese");
				ClickableGraphic chse = cheese = new ClickableGraphic(300, 300 -(burger.size() * 10), 150, 150, "resources/cheese.png");
				addObjects(chse);
			}
