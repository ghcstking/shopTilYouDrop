...
public class SammyajitCustomerScreen extends ClickableScreen implements Runnable {
	...
	public void gameOver(){
		viewObjects.clear();
		gameOver = new TextLabel(250,300,200,40,"GAME OVER");
		returnH = new Button(400,300,200,40,"Home",Color.BLUE,new Action(){
			public void act(){
				ShopTilYouDropGame.game.setScreen(ShopTilYouDropGame.mainScreen);
			}
		});
		viewObjects.add(gameOver);
		viewObjects.add(returnH);
	}
